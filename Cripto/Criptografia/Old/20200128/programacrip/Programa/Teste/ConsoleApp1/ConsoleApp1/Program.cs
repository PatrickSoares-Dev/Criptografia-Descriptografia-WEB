...
namespace ConsoleApp1
{
    class Program
    {
        ...
        public static void DEcrip()
        {
            ...
            {
                pgp.DecryptFile(@"C:\tmp\20200128\programacrip\TLC12354.ota.pgp", @"C:\tmp\20200128\programacrip\out\TLC12354.ota", @"D:\20200110\TCK.asc", "Gi?6ae}a)14Cv&U%&!U#Qp5^j!n+SH@M9_<M7uJluM;s!&L<JkN!fC`#+{q*Wu%");
                pgp.DecryptFile(@"C:\tmp\20200128\programacrip\TLC12354.out.pgp", @"C:\tmp\20200128\programacrip\out\TLC12354.out", @"D:\20200110\TCK.asc", "Gi?6ae}a)14Cv&U%&!U#Qp5^j!n+SH@M9_<M7uJluM;s!&L<JkN!fC`#+{q*Wu%");

                pgp.DecryptFile(@"C:\tmp\20200128\programacrip\TLC12355.ota.pgp", @"C:\tmp\20200128\programacrip\out\TLC12355.ota", @"D:\20200110\TCK.asc", "Gi?6ae}a)14Cv&U%&!U#Qp5^j!n+SH@M9_<M7uJluM;s!&L<JkN!fC`#+{q*Wu%");
                pgp.DecryptFile(@"C:\tmp\20200128\programacrip\TLC12355.out.pgp", @"C:\tmp\20200128\programacrip\out\TLC12355.out", @"D:\20200110\TCK.asc", "Gi?6ae}a)14Cv&U%&!U#Qp5^j!n+SH@M9_<M7uJluM;s!&L<JkN!fC`#+{q*Wu%");
        ...
        public static void Encrip()
        {
            ...
            using (PGP pgp = new PGP())
            {
                ...
                string[] aChaves = new string[] { @"D:\20200212\publicKey\watchdata.asc", @"D:\20200212\publicKey\IntelcavKey.asc", @"D:\20200212\publicKey\linksfield_pk_brasil.asc", @"D:\20200212\publicKey\linksfield_publickey.asc" };
            


                pgp.EncryptFileAndSign(@"D:\20200212\in\LF00003.INP", @"D:\20200212\out\LF00003.INP.pgp", aChaves, @"D:\20200110\TCK.asc", "Gi?6ae}a)14Cv&U%&!U#Qp5^j!n+SH@M9_<M7uJluM;s!&L<JkN!fC`#+{q*Wu%");
